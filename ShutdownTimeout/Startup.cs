...
using ShutdownTimeout.SinjulMSBH;
...
namespace ShutdownTimeout
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //? Configure the shutdown to 13s
            //?  By default, this fires after 5 seconds ..
            services.Configure<HostOptions>(_ =>
                _.ShutdownTimeout = TimeSpan.FromSeconds(13));

            //? bind the config to host options
            services.Configure<HostOptions>
                (Configuration.GetSection("HostOptions"));
        }
